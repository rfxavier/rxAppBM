namespace rxApp.Migrations
{
    ...
    public partial class v1 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.AspNetRoles", "Id", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetRoles", "Name", c => c.String(nullable: false, maxLength: 256, unicode: false));
            AlterColumn("dbo.AspNetUserRoles", "UserId", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserRoles", "RoleId", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUsers", "Id", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUsers", "Email", c => c.String(maxLength: 256, unicode: false));
            AlterColumn("dbo.AspNetUsers", "PasswordHash", c => c.String(maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUsers", "SecurityStamp", c => c.String(maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUsers", "PhoneNumber", c => c.String(maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUsers", "UserName", c => c.String(nullable: false, maxLength: 256, unicode: false));
            AlterColumn("dbo.AspNetUserClaims", "UserId", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserClaims", "ClaimType", c => c.String(maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserClaims", "ClaimValue", c => c.String(maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserLogins", "LoginProvider", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserLogins", "ProviderKey", c => c.String(nullable: false, maxLength: 250, unicode: false));
            AlterColumn("dbo.AspNetUserLogins", "UserId", c => c.String(nullable: false, maxLength: 250, unicode: false));
