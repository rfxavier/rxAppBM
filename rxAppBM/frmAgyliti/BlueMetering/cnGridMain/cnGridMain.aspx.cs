...
namespace rxAppBM.frmAgyliti.BlueMetering.cnGridMain
{
    public partial class cnGridMain : System.Web.UI.Page
    {
        ...
        {
            LinqServerModeDataSource lnsource = new LinqServerModeDataSource { ContextTypeName = "rxApp.Models.ApplicationDbContext", TableName = "BlueMeteringMessageViews" };
